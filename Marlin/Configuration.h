...
#define STRING_CONFIG_H_AUTHOR "(CBC Girard, Ender-3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3.14"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42.00, 0.00, -2.25}
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_LAYER_HEIGHT   0.4  // (mm) Default layer height for G26.
